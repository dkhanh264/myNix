    ...
    settings = {
      ...
      animations = {
        ...
        bezier = [
          ...
          "m3Decel, 0.05, 0.9, 0.1, 1.0"
          "m3Accel, 0.3, 0.0, 0.8, 0.15"
          "fluidEase, 0.25, 1.0, 0.5, 1.0"
          "spring, 0.34, 1.25, 0.64, 1.0"
        ];
        animation = [
          "windows,       1, 3.8, m3Decel, popin 88%"
          "windowsIn,     1, 3.8, m3Decel, popin 88%"
          "windowsOut,    1, 2.6, m3Accel, popin 88%"
          "windowsMove,   1, 3.5, m3Decel"
          "fadeIn,        1, 2.5, m3Decel"
          "fadeOut,       1, 2.0, m3Accel"
          "fadeSwitch,    1, 2.5, m3Decel"
          "fadeShadow,    1, 2.5, m3Decel"
          "fadeDim,       1, 2.5, m3Decel"
          "fadeLayers,    1, 2.5, m3Decel"
          "layers,        1, 3.2, m3Decel, popin 92%"
          "layersIn,      1, 3.2, m3Decel, popin 92%"
          "layersOut,     1, 2.2, m3Accel, popin 92%"
          "workspaces,    1, 3.8, m3Decel, slidefade 20%"
          "specialWorkspace, 1, 3.2, m3Decel, slidevert"
          "border,        1, 4.0, m3Decel"
        ];
      };
      ...
      layerrule = [
        ...
        "blurpopups, m3-morph-popup-host"
