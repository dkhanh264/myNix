    ...
    settings = {
      ...
      animations = {
        ...
        bezier = [
          ...
          "fluidEase, 0.16, 1.0, 0.3, 1.0"
        ];
        animation = [
          "windows,       1, 5.0, m3Decel, popin 85%"
          "windowsIn,     1, 5.0, m3Decel, popin 85%"
          "windowsOut,    1, 3.5, m3Accel, popin 85%"
          "windowsMove,   1, 4.5, m3Decel"
          "fadeIn,        1, 3.5, m3Decel"
          "fadeOut,       1, 3.0, m3Accel"
          "fadeSwitch,    1, 3.5, m3Decel"
          "fadeShadow,    1, 3.5, m3Decel"
          "fadeDim,       1, 3.5, m3Decel"
          "fadeLayers,    1, 3.5, m3Decel"
      ...
      layerrule = [
        ...
        "ignorealpha 0.60, notifications"
        "blur, m3-shell"
        "ignorezero, m3-shell"
        "ignorealpha 0.60, m3-shell"
        "blur, m3-morph-popup-host"
        "ignorezero, m3-morph-popup-host"
        "ignorealpha 0.65, m3-morph-popup-host"
        "blur, quickshell"
        "ignorezero, quickshell"
        "ignorealpha 0.60, quickshell"
        "blur, volume-osd"
        "ignorezero, volume-osd"
        "ignorealpha 0.60, volume-osd"
      ];
    };
